...
infile=/home/will/convert/video/template/'UMDK8511.mp4'	# the file you have (can be mp4 or something else, any framerate, size or aspect ratio)

filename='Petravidthickofit'		# the name how output folder should be called
vidname='Petrol Adam - Thick of it'			# the name displayed in CPvid
viddesc='Shes in the thick of it'		# the description that CPvid will display
